    ...
    <div className="flex flex-col min-h-screen bg-white font-[family-name:var(--font-geist-sans)]">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <GetStartedButton className="inline-flex items-center gap-3 rounded-full bg-gray-900 px-6 py-3 text-base font-medium text-white hover:bg-gray-700 transition-colors disabled:opacity-60 w-full sm:w-auto justify-center">
              <svg
                viewBox="0 0 24 24"
                className="w-5 h-5"
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="py-20 px-6 bg-gray-900">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <GetStartedButton className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 text-base font-medium text-gray-900 hover:bg-gray-100 transition-colors disabled:opacity-60">
            <svg
              viewBox="0 0 24 24"
              className="w-5 h-5"
              xmlns="http://www.w3.org/2000/svg"
